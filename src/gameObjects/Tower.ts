...
export class Tower {
    ...
    constructor(game, worldX, worldY, tile) {
        ...
        this.tower.update = ()=> {
            ...
            var y = this.tower.y > this.game.height*ScreenUtils.screenMetrics.scaleY - this.tower.height
                ? this.tower.y + 20
                : this.tower.y + 30;
    ...
    updateTower(tower) {
        ...
        var speed = tower.game.height*ScreenUtils.screenMetrics.scaleY / 1.3 + tower.game.height*ScreenUtils.screenMetrics.scaleY - tower.body.y / 1.3;
