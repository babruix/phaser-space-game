...
export class Menu extends Phaser.State {
    ...
    addGameTitleText() {
        this._startText = this.add.text(this.game.width / 2, this.game.height*ScreenUtils.screenMetrics.scaleY, "-[ FARTING ALIENS ]-", this._fontStyle);
        this._startText.anchor.setTo(0.5, 0.5);
        this.add.tween(this._startText).to({
            y: (this.game.height*ScreenUtils.screenMetrics.scaleY - 250) / 2
    ...
    addButtonTutorial() {
        ...
        textStartTutorial.anchor.setTo(0.5, 0.5);
        this.add.tween(textStartTutorial).to({
            y: ((this.game.height*ScreenUtils.screenMetrics.scaleY - 250) / 2) + 200
