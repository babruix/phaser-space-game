...
SpaceGame.priceStyle = {font: '50px eater', fill: '#E39B00'};
SpaceGame.priceList = {
  'satelite_freeze': 30,
  'satelite': 20,
  'tower': 70,
...
SpaceGame.Preloader.prototype = {
  preload: function () {
    ...
    game.load.image('laser_tower', 'assets/sprites/laser_tower.png');

    game.load.image('bullet', 'assets/sprites/bullet.png');
    game.load.image('freezing_bullet', 'assets/sprites/freezing_bullet.png');
    game.load.image('green_bullet', 'assets/sprites/green_bullet.png');
